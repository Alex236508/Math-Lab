...
`;
   ...
   async function ensureThreeScene() {
      ...
      threeScene.add(new THREE.Line(xAxis, new THREE.LineBasicMaterial({
         color: 0xe53935
      })));
      threeScene.add(new THREE.Line(yAxis, new THREE.LineBasicMaterial({
         color: 0x43a047
      })));
      threeScene.add(new THREE.Line(zAxis, new THREE.LineBasicMaterial({
         color: 0x1e88e5
      })));
      const step = 2;
      const tickSize = 0.25;
